											...
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link"
														href="noticelist.do?pageNum=${pageCount.currentPage-1}"
											...
											<c:forEach var="idx" begin="${pageCount.min }" end="${pageCount.max }">
												<c:choose>
													...
													<c:when test="${idx==pageCount.currentPage}">
														<li class="page-item"><a class="page-link"
														href="noticelist.do?pageNum=${idx}" style="font-weight: bold;">${idx}</a></li>
													</c:when>
													<c:otherwise>
														<li class="page-item"><a class="page-link"
														href="noticelist.do?pageNum=${idx}">${idx}</a></li>
													</c:otherwise>
												</c:choose>
											</c:forEach>
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item">
												        <a class="page-link" href="noticelist.do?pageNum=${pageCount.currentPage+1}" aria-label="Next">
