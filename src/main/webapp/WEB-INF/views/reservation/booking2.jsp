									...
									<div id="info">
										<div class="p-3 p-lg-5 border">
												...
												<tbody>
													<tr>
														...
														<td class="hab"><fmt:formatNumber
																value="${reserves.pensionRoomPrice }" pattern="#,###" />원
																<input type="hidden" id="reservationPrice" name="reservationPrice" value="${reserves.pensionRoomPrice }">
														</td>
													</tr>
													<tr>
														<td class="text-black font-weight-bold"><strong>TOTAL</strong></td>
														<td class="text-black font-weight-bold"><strong id="totalPrice">
														<fmt:formatNumber value="${reserves.pensionRoomPrice }" pattern="#,###" />원
														</strong></td>
												</tbody>
											</table>
											<div class="row">
											...
											<input type="hidden" id="pensionId" name="pensionId"
												value="${reserves.pensionId }"> <input type="hidden"
												id="pensionSubId" name="pensionSubId"
												value="${reserves.pensionSubId }"> <input
