											...
											<table class="table site-block-order-table mb-5">
												...
												<tbody>										
													<tr>
														...
														<td class="title">${reserves.pensionName } (${reserves.pensionRoomName })</td>															
														<td class="hab"><fmt:formatNumber value="${reserves.pensionRoomPrice }" pattern="#,###" />원</td>
													</tr>
													<tr>
														<td class="text-black font-weight-bold"><strong>TOTAL</strong></td>
														<td class="text-black font-weight-bold"><strong>
														<fmt:formatNumber value="${reserves.pensionRoomPrice }" pattern="#,###" />원</strong></td>
													</tr>
												</tbody>
											</table>
											<div class="row">
