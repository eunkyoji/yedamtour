...
<body>
	...
	<div class="container-xxl py-5">
		<div class="container">
			...
			<div class="row g-4">
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="height: 20%" >
				...
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s" >
					<a class="service-item d-block rounded text-center h-1001 p-4"
						href="aquarium.do"> <img class="maincategoryImg" src="ticket/img/아쿠아리움.png"
						alt="아쿠아리움">
						<h4 class="mb-0">아쿠아리움</h4>
					</a>
				</div>
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s" style="height: 20%">
					<a class="service-item d-block rounded text-center h-100 p-4"
				...
				<div class="row g-4">
					...
					<div class="row g-4">
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
							<a class="service-item d-block rounded text-center alllist p-4"
								href=""> <img class="img-fluid rounded mb-4"
								src="ticket/img/에버랜드.jpg" alt="에버랜드">
								<h4 class="mb-0">용인 에버랜드</h4> <span>가격</span><br> <span>상세내용</span>
						...
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
							<a class="service-item d-block rounded text-center alllist p-4"
								href=""> <img class="img-fluid rounded mb-4"
								src="ticket/img/아쿠아리움.jpg" alt="아쿠아리움">
								<h4 class="mb-0">대구 아쿠아리움</h4> <span>가격</span><br> <span>상세내용</span>
							</a>
						</div>
						<div align="center">
