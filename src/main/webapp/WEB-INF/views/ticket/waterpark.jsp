...
<body>
			...
			<div class="row g-4">
				...
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s"
					...
					<a class="service-item d-block rounded text-center h-1001 p-4"
						href="waterpark.do"> <img class="maincategoryImg"
	...
	<div class="container-xxl py-5">
		<div class="container">
			<div class="text-center mx-auto mb-5 wow fadeInUp"
				...
				<h1 class="display-6 mb-4">워터파크 리스트</h1>
			</div>

			<div class="iii row g-4">
				<c:forEach items="${vo}" var="w">
				
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
						<a class="service-item d-block rounded text-center alllist p-4"
							href="waterparkdetail.do?id=${w.waterparkId }"> <img
							class="img-fluid rounded mb-4"
							src="ticket/img/waterpark/${w.waterparkImg }"
							style="width: 370px; height: 210px" alt="">
							<h4 class="mb-0">${w.waterparkName }</h4> <span>${w.waterparkPrice }원</span><br>
							<span>${w.waterparkBrif }</span>
						</a>
					</div>
	...
	<script>
		/* $('.aqualist').on('click', function() {
			...
			$.ajax({
				url : 'detailticket.do?id=' {a.waterparkId},
				method : 'post',
				data : {
					id : $('.ticketId').val()
