              ...
              <div class="card position-relative shadow" style="max-width: 370px;">               
                <div class="card-body p-3"> <img class="mb-4 mt-2 rounded-2 w-100" src="jadoo/public/assets/img/steps/booking-img.jpg" alt="booking" />
                  ...
                  <h5 class="fw-medium">가는날</h5>
                    <h5 class="fw-medium">${t.trainGoday }2023.09.18(월)</h5>
                    <p class="fs--1 mb-3 fw-medium">${t.trainStart }부산 -> ${t.trainFinish }동대구</p>
                    <p class="fs--1 mb-3 fw-medium">등급: ${t.trainGrade }KTX</p>
                    <p class="fs--1 mb-3 fw-medium">인원: ${t.trainPerson }1명</p>
                    <p class="fs--1 mb-3 fw-medium">좌석: ${t.trainSeats }20</p>    
                    </c:forEach>            
                  </div>
                </div>
              </div>
              ...
              <div class="card position-relative shadow" style="max-width: 370px;">               
                <div class="card-body p-3"> <img class="mb-4 mt-2 rounded-2 w-100" src="jadoo/public/assets/img/steps/booking-img.jpg" alt="booking" />
                  ...
                  <h5 class="fw-medium">오는날</h5>
                     <h5 class="fw-medium">${t.trainGoday }2023.09.19(월)</h5>
                    <p class="fs--1 mb-3 fw-medium">${t.trainFinish }동대구 -> ${t.trainStart }부산</p>
                    <p class="fs--1 mb-3 fw-medium">등급: ${t.trainGrade }KTX</p>
                    <p class="fs--1 mb-3 fw-medium">인원: ${t.trainPerson }1명</p>
                    <p class="fs--1 mb-3 fw-medium">좌석: ${t.trainSeats }24</p>
                    </c:forEach>
                    </div>               
                  </div>
                </div>
