...
<body>
		<div class="untree_co-section before-footer-section">
			<form action="resulttrain.do" class="col-md-12" method="post">
						...
						<div class="site-blocks-table">
							<table class="table">
								...
								<tbody>
									...
									<tr>
										<td><input type="radio" value="${t.trainId }" name="direction"></td>
						...
						<div class="site-blocks-table">
							<table class="table">
								...
								<tbody>
									<c:forEach items="${trains }" var="t">
									<tr>
										<td><input type="radio" value="${t.trainId }" name="direction1"></td>
										<td class="product-name">
											<h2 class="h5 text-black">${t.trainGrade }</h2>
										</td>
										<td>${t.trainDeptime }</td>
