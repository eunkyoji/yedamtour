		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-7 col-12 mb-4 mb-md-6 mb-lg-0 order-0">
					<img class="mb-4" src="jadoo/public/assets/img/logo2.svg" width="150"
						alt="jadoo" />
				...
				<div class="col-lg-2 col-md-4 mb-4 mb-lg-0 order-lg-1 order-md-2">
					...
					<ul class="list-unstyled mb-0">
						<li class="mb-2"><a
							class="link-900 fs-1 fw-medium text-decoration-none" href="#!">About</a>
						</li>
						<li class="mb-2"><a
				...
				<div class="col-lg-2 col-md-4 mb-4 mb-lg-0 order-lg-2 order-md-3">
					...
					<ul class="list-unstyled mb-0">
						...
						<li class="mb-2"><a
							class="link-900 fs-1 fw-medium text-decoration-none" href="#!">Press</a>
						</li>
						<li class="mb-2"><a
				...
				<div
					...
					<div class="d-flex align-items-center">
						<a href="#!"> <img class="me-2"
							src="jadoo/public/assets/img/play-store.png" alt="play store" /></a><a href="#!">
							<img src="jadoo/public/assets/img/apple-store.png" alt="apple store" />
						</a>
					</div>
				</div>
			</div>
